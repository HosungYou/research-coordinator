...
1. **CP_PARADIGM_SELECTION** 🔴 - 연구 패러다임 선택
2. **CP_RESEARCH_DIRECTION** 🔴 - 연구 방향 결정
...
1. **CP_METHODOLOGY_APPROVAL** 🔴 - 연구 방법론 승인 시
2. **CP_VS_001** 🔴 - VS 대안 제시 후 선택 시
3. **CP_VS_003** 🔴 - 선택 방향 최종 확인 시
